...
N38, N30,   N31,   K32,   K33,   K34,     K35,   K36,   K37,          N39 \
) \
LAYOUT_no_ball( \
K00,   K01,   K02,   K03,   K04,          K05,   K06,   K07,   K08,   K09, \
K10,   K11,   K12,   K13,   K14,          K15,   K16,   K17,   K18,   K19, \
K20,   K21,   K22,   K23,   K24,          K25,   K26,   K27,   K28,   K29, \
N38, N30,   N31,   K32,   K33,   K34,   K35,   K36,   XXX, XXX, XXX, N39 \
)
// clang-format on
...
KC_TRNS, KC_TRNS,         KC_TRNS,        LSFT(KC_APP), LSFT(KC_SPC), LSFT(KC_TAB),  U_NA,   U_NA,    U_NA,          KC_TRNS
...
KC_GRV, KC_LBRC,        KC_QUOT ,         LT(U_MEDIA,KC_ESC), LT(U_NAV,KC_SPC), LT(U_MOUSE,KC_TAB), LT(U_SYM,KC_ENT), LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL), KC_RBRC
...
KC_TRNS, KC_TRNS,    KC_TRNS, KC_DOT, KC_0, KC_MINS, U_NA,           U_NA,            U_NA,          KC_TRNS
...
U_NA,          U_NA,    U_NA,    U_NA,    U_NA,      KC_BTN4, U_NU,    SCRL_MO_HOR, KC_BTN5, U_NA,        \
KC_TRNS, KC_TRNS,          KC_TRNS,    U_NA,    U_NA,    U_NA,      KC_BTN2, KC_BTN1, KC_BTN3,     KC_TRNS

#define MIRYOKU_LAYER_MEDIA \
TD(U_TD_BOOT), U_NA,    U_NA,    U_NA,    U_NA,   RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_TOG, \
KC_LGUI,       KC_LALT, KC_LCTL, KC_LSFT, KC_MEH, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, U_NU,    \
U_NA,          U_NA,    U_NA,    U_NA,    U_NA,   U_NU,    U_NU,    U_NU,    U_NU,    OU_AUTO, \
KC_TRNS, KC_TRNS,          KC_TRNS,    U_NA,    U_NA,    U_NA,   KC_MSTP, KC_MPLY, KC_MUTE, KC_TRNS
...
KC_TRNS, KC_TRNS,   KC_TRNS,  KC_APP, KC_SPC, KC_TAB,  U_NA,   U_NA,    U_NA,    KC_TRNS

#define MIRYOKU_LAYER_NAV \
TD(U_TD_BOOT), U_NA,    U_NA,    U_NA,    U_NA,   LCTL(KC_B), LCTL(KC_D), LCTL(KC_U), LCTL(KC_F), U_NA,    \
...
KC_TRNS, KC_TRNS,          KC_TRNS,    U_NA,    U_NA,    U_NA,   KC_ENT,     KC_BSPC,    KC_DEL,     KC_TRNS
...
KC_TRNS, KC_TRNS,    KC_TRNS,    KC_LPRN, KC_RPRN, KC_UNDS, U_NA,   U_NA,    U_NA,    KC_TRNS
