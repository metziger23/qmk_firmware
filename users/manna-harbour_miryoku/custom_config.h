...
KC_QUOTE, KC_4, KC_5,   KC_6, KC_EQL,  MEH_T(KC_LEFT), LSFT_T(KC_DOWN), LCTL_T(KC_UP), LALT_T(KC_RIGHT), KC_LGUI,       \
KC_GRV,   KC_1, KC_2,   KC_3, KC_BSLS, U_NA,           U_NA,            U_NA,          U_NA,             U_NA,          \
U_NP,     U_NP, KC_DOT, KC_0, KC_MINS, U_NA,           U_NA,            U_NA,          U_NP,             U_NP

/*
#define MIRYOKU_LAYER_MOUSE \
TD(U_TD_BOOT), U_NA,    U_NA,    U_NA,    U_NA, U_NA, U_RDO,   U_PST,   U_CPY,   U_CUT,   U_UND, \
KC_LGUI,       KC_LALT, KC_LCTL, KC_LSFT, U_NA, U_NA, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, U_NU,  \
U_NA,          U_NA,    U_NA,    U_NA,    U_NA, U_NA, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, U_NU,  \
U_NP,          U_NP,    U_NA,    U_NA,    U_NA, U_NA, KC_BTN2, KC_BTN1, KC_BTN3, U_NP,    U_NP
