...
LSFT(KC_F11),     LSFT(KC_F4),      LSFT(KC_F5),      LSFT(KC_F6),      LSFT(KC_SCRL),    U_NA,             KC_LSFT,          LSFT(KC_LCTL),    LSFT(KC_LALT),    LSFT(KC_LGUI),    \
...
KC_Z,              HYPR_T(KC_X),      MEH_T(KC_C),       KC_D,              KC_V,              KC_K,              LT(U_FUN,KC_H),    MEH_T(KC_COMM),    HYPR_T(KC_DOT),    KC_SLSH,           \
...
U_NA,              KC_HYPR,           KC_MEH,            U_NA,              U_NA,              U_NU,              KC_BTN4,           SCRL_MO_FRE,       SCRL_MO_HOR,       KC_BTN5,           \
KC_TRNS,           KC_TRNS,           KC_TRNS,           U_NA,              U_NA,              U_NA,              KC_MUTE,           KC_DEL,            KC_BTN3,           KC_TRNS
